document.addEventListener("DOMContentLoaded", () => {
  ...
  tshirtColor.addEventListener("change", () => {
    document.getElementById("tshirt-backgroundpicture").style.backgroundColor =
      tshirtColor.value;
  });
  ...
  //click add triangle
  document
    .querySelector("button.btn.triangle")
  ...
  //click gallary event listener=>show gallary container/display all tshirts
  ...
  gallaryButton.addEventListener("click", () => {
    ...
    document
      .getElementById("gallaryCloseButton")
      .addEventListener("click", () => {
  ...
  function fetchTshirts() {
    fetch("https://qtee-api.herokuapp.com/tshirts")
      .then((resp) => resp.json())
  ...
  tshirtForm.addEventListener("submit", (e) => {
    ...
    function userFormSubmission(e) {
      ...
      fetch("https://qtee-api.herokuapp.com/users", configObj)
        .then((resp) => resp.json())
